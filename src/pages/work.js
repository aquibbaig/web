        ...
        <Box pl={2}>
          <List>
            ...
            <ListItem d="flex">
              ⛏️
              <Text ml={2}>
                Built a dashboard for visualising data curated by the
                bench-routes server
              </Text>
            </ListItem>
            <ListItem d="flex">
            ...
            <ListItem d="flex">
              👾
              <Text ml={2}>
                Some competitive programming questions on codeforces
              </Text>
            </ListItem>
          </List>
        </Box>
            ...
            <List>
              <ListItem d="flex">
                ...
                <Text ml={2}>
                  ...
                  , a collection of rarely visited topics in go programming
                  language
                </Text>
              </ListItem>
              <ListItem d="flex">
                ...
                <Text ml={2}>
                  ...
                  , a fun card game for native devices usually played among 4-6
                  people
                </Text>
              </ListItem>
          ...
          <AccordionPanel pl={2}>
            <List>
              <ListItem d="flex">
                🏆{" "}
                <Text>
                  Google summer of code intern at FOSSi, contributed to{" "}
                  <a
                    className={clsx([
                      styles.rlink,
                      styles.animatedunderline,
